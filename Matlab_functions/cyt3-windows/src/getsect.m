function rect = getsect(varargin)
%GETRECT Select rectangle with mouse.
%   SECT = GETSECT lets you select a sectangle in the current axes using
...
%   to begin the drag.
%
%   RECT = GETSECT(FIG) lets you select a rectangle in the current axes of
%   figure FIG using the mouse.
%
%   RECT = GETSECT(AX) lets you select a rectangle in the axes specified by
%   the handle AX.
%
%   Example
%   --------
...
%   $Revision: 5.22.4.10.2.1 $  $Date: 2011/07/18 00:33:31 $
