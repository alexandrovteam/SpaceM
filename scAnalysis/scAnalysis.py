...
def defMOLfeatures(MF,
                   ...
                   area_prop=0.3,
                   fetch_ann='online',
                   hdf5_path='C:/Users/rappez/Google Drive/A-Team/projects/1c/co-culture/datasets/all_annotations/2018-08-06-luca-datasets.hdf5'):
    ...
    fluo = tiff.imread(MFA + 'CellProfilerAnalysis/img_t2_z1_c1.tif')
