...
ir.penMarksFeatures(MFA, folder=MFA_Spom, picXcoord=POST_picXcoord, picYcoord=POST_picYcoord, prefix='post', int_treshold = [])
ir.penMarksFeatures(MFA, folder=MFA_Sprm, picXcoord=PRE_picXcoord, picYcoord=PRE_picYcoord, prefix='pre', int_treshold = [])

ir.fiducialsAlignment(MFA) #performs registration of SURF features coordinates from both datasets.
